...
from .views import CustomTokenObtainPairView, UserDetailView, AdminDashboardView , UserDeleteView , TeacherDashboardView, UserCreateView, TeacherFileUploadView , TeacherFileDownloadView
